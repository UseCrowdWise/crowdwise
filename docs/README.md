...
1. Get Ruby and the `gem` command
1. `gem install jekyll jekyll-gist jekyll-sitemap jekyll-seo-tag`
1. `bundle install` inside this folder
1. `bundle exec jekyll serve` to serve the page
...
<img alt="Mobile post page" src="/_screenshots/q3.png?raw=true" width="300px" />
