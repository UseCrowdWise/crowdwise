import {
  ...
  DEFAULT_SHOULD_USE_OLD_REDDIT_LINK,
...
export const INITIAL_SETTING_VALUES = {
  ...
  [KEY_SHOULD_USE_OLD_REDDIT_LINK]: DEFAULT_SHOULD_USE_OLD_REDDIT_LINK,
  ...
  [KEY_RESULT_FEED_FILTER_BY_MIN_LIKES]:
    DEFAULT_RESULT_FEED_FILTER_BY_MIN_LIKES,
  [KEY_RESULT_FEED_FILTER_BY_MIN_DATE]: DEFAULT_RESULT_FEED_FILTER_BY_MIN_DATE,
};
